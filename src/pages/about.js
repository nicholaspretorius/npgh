...
export default () => (
  <Container>
    <p>I am a web developer, designer and user experience (UX) consultant.</p>

    <p>
      I code with JavaScript in various flavours such as ES6, TypeScript,
      AngularJs, Angular, Node.js, Nest.js and React.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>
        <a
          href="https://sourcerer.io/nicholaspretorius"
          target="_blank"
          rel="noopener noreferrer"
        >
          Sourceror

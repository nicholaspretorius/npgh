...
export default () => (
    <Container>
        ...
        <ul>
            ...
            <li>Learning: Nest.js, Typescript, Angular, Ionic, Gatsby.</li>
            ...
            <li>Listening (Music): Zola Blood - Infinite Games, Moderat - Moderat II &amp; Moderat III</li>
            <li>Watching (Series): Ozark. Season 2, Hinterland. Season 1.</li>
        </ul>
